...
class _RegisterPageState extends ConsumerState<RegisterPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final verificationId = await ref.read(authProvider.notifier).register(
        _nameCtrl.text.trim(),
      ...
      setState(() { _error = 'Ошибка регистрации. Проверьте данные и попробуйте снова.'; });
    } finally {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: AppSpacing.xl),
                WlButton(label: 'Зарегистрироваться', onPressed: _submit, loading: _loading),
                const SizedBox(height: AppSpacing.md),
                TextButton(
