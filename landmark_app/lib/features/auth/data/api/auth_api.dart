...
class AuthApi {
  ...
  Future<Map<String, dynamic>> register(
    ...
    final r = await dio.post(ApiEndpoints.authRegister,
        data: {'name': name, 'email': email, 'password': password});
    return r.data as Map<String, dynamic>;
  }

  Future<void> verifyEmail(String verificationId, String code) async {
    await dio.post(ApiEndpoints.authVerifyEmail,
        data: {'verification_id': verificationId, 'code': code});
  }

  Future<Map<String, dynamic>> login(String email, String password) async {
    final r = await dio.post(ApiEndpoints.authLogin,
  ...
  Future<void> logout(String refreshToken) async {
    await dio
        .post(ApiEndpoints.authLogout, data: {'refresh_token': refreshToken});
  }
